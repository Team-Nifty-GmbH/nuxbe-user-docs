...
| **Sammelauftrag** | Führt mehrere bestehende Aufträge oder Lieferscheine zu einem Gesamtauftrag zusammen | [Sammelaufträge](9-sammelauftraege.md) |
...
|---|---|---|---|
| **Verkauf** | Angebot, Auftrag, Abonnement, Split-Auftrag, Sammelauftrag | +1 | Einnahme -- Beträge werden als positiver Umsatz gewertet |
